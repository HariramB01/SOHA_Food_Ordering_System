...
public class User {
	...
	public User(Long id, String fullName, String password, String email, USER_ROLE role, List<Order> orders,
	...
	public String toString() {
		return "User [id=" + id + ", fullName=" + fullName + ", password=" + password + ", email=" + email + ", role="
				+ role + ", orders=" + orders + ", favourites=" + favourites + ", addresses=" + addresses + "]";
	}
